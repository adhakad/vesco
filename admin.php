<?php
		...
		if (isset($_POST['submit'])){
			...
			if (isset($_FILES['image']['tmp_name'])) {
  			...
  			$image = $name;
				...
				$uery = "INSERT INTO images(img) VALUES('$image')";
		...
		<body>
					...
					<div class="col-md-4">
							...
							<div class="panel-heading text-center"style="background: linear-gradient(to top, #f3d400,#ff6600);height: 70px;color: #000;">Main Home Image Slider</div>
									...
									<?php while($row = $read->fetch_assoc()) {  ?>
										<tr style="border: 1px solid #f38900; ">	
											<td style="border: 1px solid #f38900; ">
                                                                                            <img src="<?php echo 'img/work/'.$row['img'];?>" width="220px" height="120px " style="margin-bottom: 10px;margin-left: 30px;" />
											</td>
